...
class WodViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, NSFetchedResultsControllerDelegate, UITextViewDelegate, UISearchBarDelegate {
    ...
    func getWodData(){
        ...
        girlWods = [
            ...
            Workout(name:"Betty", typeDescription:"5 rounds for time", description:"12 Push Press (135 lbs/95 lbs)\n20 Box Jumps", type: "For time", color: "orange"),
            Workout(name:"Candy", typeDescription:"5 rounds for time", description:"20 pull-ups\n40 push-ups\n60 squats", type: "For time", color: "orange"),
            Workout(name:"Charlotte", typeDescription:"21-15-9 reps for time", description:"Overhead Squats (95/65)\nSumo Deadlift High Pull (95/65)", type: "For time", color: "orange"),
